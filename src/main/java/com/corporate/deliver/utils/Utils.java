...
public class Utils {
	...
	public static void sendEmail(String toEmailAddr) {
		
		SendMail sendMail = new SendMail();
		sendMail.sendEmail(HibernateConfiguration.getEmail_user(), HibernateConfiguration.getEmail_password(), toEmailAddr);
	}
