...
public class RestaurantController {
    ...
    public  @ResponseBody List<Restaurant>  getRestaurantsWithDateAndTime( @RequestParam("zipBustypeMerchantId") String zipBustypeMerchantId , @RequestParam("date") String dateValue, @RequestParam("time") String time, @RequestParam("orderType") String orderType) {
    ...
    public  @ResponseBody List<ZipBusTypeMerchant>  getOrderTypes( @RequestParam("city") String city, @RequestParam("state") String state, @RequestParam("zipcode") String zipcode) {
