	...
	$("#btn_summary_report").click(function(e){
		...
		$.ajax({
		   ...
		   success: function(data) {
				...
				'<td style="width:150px;height:50px;padding-left: 10px;"><label>Tax</label></td>'+
				'<td style="width:150px;height:50px;padding-left: 10px;"><label>Tip</label></td>'+
				'<td style="width:150px;height:50px;padding-left: 10px;"><label>Delivery Charge</label></td>'+
