...
<div class="top_menu" id="top_menu">   
 <table cellpadding=0 id="menu" style="font-weight:bold;width: 1400px;">
   ...
   <tr class="spaceUnder">
	...
	<td width=8%><a href="/delivery/merchants/"><img id="logohome" src="${pageContext.request.contextPath}/resources/images/delivery22.jpg" 
	style="padding-bottom:35px;margin-bottom:0px;padding-right:50px;height:120px;width:140px;margin-right:300px;"/></a></td>
	
	<td width=15%><a href="/delivery/merchants/" id="gohome"
	...
	<td><button type="button" id="register" value="Sign Up" class="btn btn-danger btn-group-justified" data-toggle="modal" data-target="#myModal_createaccount"
...
<div class="portal" id="portal" style="align:center;display:block;">
	...
	<td width=50px style="padding-left:330px;"><button type="button" id="login_btn" class="btn btn-danger" 
			 style="width:150px;height:60px;border-radius:30px;" data-toggle="modal" data-target="#myModal_login">Sign In</button></td>
	
	
			 
	<td width=50px style="padding-left:120px;"><button type="button" id="register_btn" class="btn btn-danger" 
			 style="width:150px;height:60px;border-radius:30px;float:left;">Contact Us</button></td>
			 </tr>
			 </table>
 </div>  
 <br/>
 <div class="welcome_portal" id="welcome_portal" style="align:center;display:none;height:350px;">
		...
		<div style="font-weight:bold;font-family:Impact;padding-left:320px;margin-top:20px;margin-bottom:20px;padding-top:20px;color:red"><h3>Welcome to Merchant Management Portal</h3></div><br/>
<table>
	<tr style="margin-bottom:20px; padding-bottom: 1.1em;"></tr>
	<tr style="margin-top:20px;margin-bottom:10px;"></tr>

	
	<td style="padding-left:100px;"><button type="button" id="btn_restaurant" class="btn showhover" 
			 style="border-radius: 100%;width:228px;height:228px;background-image: url(${pageContext.request.contextPath}/resources/images/rest1.png);"></button></td>
			 
	<td style="padding-left:70px;"><button type="button" id="btn_summary_report" class="btn showhover"
			 style="border-radius: 100%;width:228px;height:228px;background-image: url(${pageContext.request.contextPath}/resources/images/rep1s.png);"></button></td>
	
	<td style="padding-left:70px"><button type="button" id="btn_detailed_report" class="btn showhover" 
	style="border-radius: 100%;width:228px;height:228px;background-image: url(${pageContext.request.contextPath}/resources/images/rep2.png);"></button></td></tr>
	</table>
...
<p class="glyphicon glyphicon-chevron-left" style="vertical-align:top;float:left;position:relative;background-color:#dadada"> Go back to Main Page</p></div>-->
	  ...
	  <table id="table_rest" style="margin-top:10px;margin-left:55px;">
	  </table>
      </div></div>
	  ...
	  <table id="table_menu" style="margin-top:10px;margin-left:55px;">
	  </table>
	  </div>
	  ...
	  <table id="table_section" style="margin-top:10px;margin-left:5px;">
	  </table>
	  ...
	  <label style="margin-top:100px;margin-left:500px;font-size:26px">Summary Page</label><br/>
	  <div class="col-md-2">
	 From <input id="date_start" type="text" class="form-control"  placeholder="Select From date" style="margin-left:10px;width:150px"  /></div>
	 <div class="col-md-2">
	 To <input id="date_end" type="text" class="form-control" placeholder="Select To date" style="margin-left:10px;width:150px"></div><br/>
	   <button type="button" class="btn" style="margin-left:1205px;width:100px" id="go_to_welcome_pg">
	  Go back to Main Page</button><br/>
	  
	  <table id="table_summary" style="margin-top:10px;margin-left:10px;">
	  </table>
