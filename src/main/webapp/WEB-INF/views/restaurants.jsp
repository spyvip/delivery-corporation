...
<div class="top_menu" id="top_menu">   
 <table cellpadding=0 id="menu" style="font-weight:bold;width: 1400px;">
   ...
   <tr class="spaceUnder">
	...
	<td width=15%>
		<a id="gohome" >
		<b style="font-size:30px;">Ace </b><br/><span style="padding-left:50px;">Express Delivery</span></a></td>
	<td width=350px></td>
	<td width=150px style="text-decoration:none;margin-top:50px;cursor: pointer;margin-left:70px">
		<a id="login" style="color:red;display:block;margin-left:50px;margin-top:10px" data-toggle="modal" data-target="#myModal_login"><b>
		Sign In</b></a>
		<a id="logged_in" style="display:none;color:black;margin-top:10px"></a></td>

	<td><button type="button" id="register" value="Sign Up" class="btn btn-danger btn-group-justified" data-toggle="modal" data-target="#myModal_register"
			 style="width:80px;height:auto;border-radius: 30px;display:block;margin-left:20px;">Sign Up</button></td>
	
	
	<td><button type="button" id="sign_out" value="Sign out" class="btn btn-danger btn-group-justified" 
			 style="width:80px;height:auto;border-radius: 30px;display:none;margin-right:120px;">Sign Out</button></td>
...
<div id="div_address" class="div_address" style="display:block;margin-top:55px;background-image: url(${pageContext.request.contextPath}/resources/images/pic6.jpg);">
 ...
 <table>
      <tr>
	  <td width=75%><input id="autocomplete" placeholder=" Street address, city, state"
             onFocus="geolocate()" type="text" style="position:relative;width:500px;margin-left:270px;height:35px; font-size:14pt;"/></td>
	  <td><button type="submit" id="find_btn" value="Find" class="btn btn-danger btn-group-justified"
			 style="width:55px;height:auto;margin-left:30px;">Find</button></td></tr>
 </table>
</div>
	...
	<div id="select_btn" style="display:none">
	</div>
	
	<div id="hideerror_details" style="display:none">
	</div>
	
	<table>
	 <tr id="date_time_corp" style="display:none">
	  <td>
	   <div class="dropdown" style="margin-left:360px;margin-top:30px;width:130px">
        <button id="dd_btn1" class="btn dropdown-toggle" type="button" style="width:130px;background-color:#eec591" data-toggle="dropdown">
            Select Date
            <span class="caret"></span>
        </button>
        <ul id="dd_date_corp" class="dropdown-menu" style="width:130px">
			<li><a  id="demo0" onclick="set_corp_time()"> </a></li>
            <li><a id="demo1"></a></li>
            <li><a id="demo2"></a></li>
            <li><a id="demo3"></a></li>
			<li><a id="demo4"></a></li>
	...
	<td>
	 <div class="dropdown" id="time"  style="margin-left:50px;margin-top:30px;width:130px;">
        <button id="dd_btn2" class="btn dropdown-toggle" type="button" data-toggle="dropdown" style="background-color:#eec591;width:130px;">
           Select Time
            <span class="caret"></span>
        </button>
        <ul id="dd_time_corp" class="dropdown-menu" style="width:130px">
            <li><a id="time1">11.30 AM</a></li>
            <li><a id="time2">12.30 PM</a></li>
            <li><a id="time3">01.30 PM</a></li>
        </ul>
     </div>
  	</td>
	</tr>
...
<div id="div_carousel" style="display:block;margin-top:10px;">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="when" id="when" style="display:none">   
 	<table border=0 width=100% cellpadding=0 >
  	 <tr>
	 <td style="margin-left:10px;width:270px;">  
	 <div class="dropdown">
        <button id="dd_btn3" class="btn dropdown-toggle" type="button" data-toggle="dropdown" style="background-color:orange;margin-left:10px" >
	...
	<td style="width:250px;margin-right:20px;margin-left:20px;float:left"> 
		<input type="text" class="form-control" placeholder="Company name" id="company_name"/>
	</td>
	<td style="width:120px;margin-left:30px;float:left;">
		<input type="text" class="form-control" placeholder="Suite number" id="suite_number"/>
	</td>
</tr>
</table>    
</div>    
	...
	<div id="backto_rest" style="display:none;" type="button" class="btn btn default">
		<p class="glyphicon glyphicon-chevron-left" style="vertical-align:top;float:left;font-size:22px;position:relative" id="back_restname"></p>
	</div>
	...
	<table class="restName">
		<tr>
			<td>
		<div class="href">
  	<table align="top" class="restName" id="select_rest" style="width:1100px;display:none;">	
 	</table>
  	</div>
  	</td>
  </tr>
  ...
  <div id="div_menus" class = "restName col-md-8">
	   <table class="restName">
	      <tr>
	         <td>
	            <div class="href">
	               <table id="table_menus" align="top" class="restName" style="width:1100px;display:none;margin-bottom:10px;">
	               </table>
	            </div>
	         </td>
	       </tr>
	...
	<div class = "cart" class="col-md-3" id="showcart" style="display:none;">

	
	<div class="col-md-12" style="font-family:Times New Roman">
        <br />
        <div class="col-md-12">
		<table border=1 style="width:100%;margin-left:0px;padding-left:0px;" >
			<tr><img src="${pageContext.request.contextPath}/resources/images/icon_cart.png" />&nbsp;&nbsp;Your Cart</tr>
			

            <table id="cartTable" style="width:100%; align-items:left">
                
                <tbody id="tid" style="width:100%;height:50px;overflow-y: auto;">
				
				</tbody>
            </table>
            
            <table style="width:100%; align-items:left;margin-top:10px;">
              <tr style="margin-bottom:10px;"><td width=10%></td> 
			   <td style="font-size:16px;font-weight:bold;width:150px">Subtotal</td>
				
				<td><span id="sales_subtotal" style="font-size:16px;font-weight:bold;float:left;"></span></td>
	...
	<div class = "cart" class="col-md-push-3" id="show_empty_cart" style="display:none;margin-bottom:10px;">
	...
	<div class="col-md-12" style="font-family:Times New Roman">
		...
		<table border=1 style="width:100%;">
			<tr><img src="${pageContext.request.contextPath}/resources/images/icon_cart.png" style="padding-left:70px;"/>&nbsp;&nbsp;Your Cart is Empty</tr><br/>
			<tr><img src="${pageContext.request.contextPath}/resources/images/shopping_cart_red.png" 
			style="height:100px;width:120px;margin-left:100px;"/></tr>
			</table>
        </div>
		 </div>
 		  </table>
  ...
  <br/>
                ...
                <div class="form-group">
                  <button type="button" class="btn btn-success" id="submit_login" style="font-size:16px;width:100%;font-weight:bold">Sign In</button></div>
  ...
  <div class="input-group">
      ...
      <input type="email" class="form-control" name="forgotpass_email" id="forgotpass_email" placeholder="Please Enter your Email">
                  ...
                  <button type="button" id="submit_forgotpass" class="btn btn-success" style="font-size:16px;width:100%;font-weight:bold">Submit</button></div>
                    ...
                    <div class="modal-content" class="col-md-12">
                        ...
                        <div class="modal-header" class="col-md-12">
							...
							<div class="col-md-6"><span>
								...
								<div style="display:none" name="rest_price" id="rest_price"></div></span>
						...
						<div style="display:none" name="display5" id="display5"></div>
						<div style="display:none" name="display6" id="display6"></div>
						<div style="display:none" name="display7" id="display7"></div>
						<div style="display:none" name="save_menuid" id="save_menuid"></div>
<br/>
                        ...
                        <div class="modal-body col-md-12" id="section_chk">
                            <br/>
                             ...
                             <table id="hide_section_id" style="display:none">
							 </table>
							 <table id="hide_id" style="display:none">
							 </table>
 ...
 <a style="text-decoration:none;color:black;font-size:16px;cursor: pointer;" id="corp_review_rest_back">Restaurant </a><p style="font-size:18px" class="fa">&#xf054;</p>
 ...
 <a style="text-decoration:none;color:black;font-size:16px;cursor: pointer;" id="rest_review_rest_back">Restaurant </a><p style="font-size:18px" class="fa">&#xf054;</p>
 ...
 <embed id="frPDF" height="10" type="application/pdf" width="800" src="http://eurecaproject.eu/files/5013/9885/7113/example4.pdf"></embed>
  ...
  <label style="width:70px;margin-bottom:5px;font-weight:lighter">When:</label><label style="width:200px;font-weight:lighter"" align="left" id="date_delivery"></label>
  <br/>
...
<div style=" padding-bottom: 20px;">
         <div><h5><label width=15%></label><label style="width:445px;font-weight:lighter;padding-left:20px"> Your Credit & Debit Cards</label>
 ...
 <div id="review_order_details" style="border:1px solid #dadada;padding-left:10px;display:block">
  ...
  <h4 style="font-size:24px;font-family:Times New Roman">
  Order Details</h4><br/>
  <div id="cart_item_details" style="padding-left: 30px;">
  </div>
  </div>
  <br/>
 <!-- <div id="print_review_order_details" style="border:1px solid #dadada;padding-left:10px;display:none">
  ...
  Order Summary</h4><br/>
	...
	<span style="display:none" id="base_review_subtotal"></span><span style="display:none" id="rest_review_subtotal"></span></div><br />
	<div style="width:600px;" class="col-md-12">
	<div class="col-md-3" style="float:left;padding-right:30px">Coupon</div>
	<div class="col-md-2" style="padding-bottom:20px;margin-left: 40px;" id="review_coupon"><a style="cursor:pointer">Apply Coupon</a></div><div id="hide_coupon" style="display:none">0</div>
	<div class="col-md-push-6"><a id="remove_coupon" style="display:none">Remove</a></span></div></div><br />
   ...
   <!-- <div style="width:320px;padding-left:30px" class="col-md-12">Delivery Charges<span style="float:right;padding-right:60px" id="review_delivery_charges"></span></div><br />-->
	...
	<!--<div class="col-md-6" >
	<button type="button" class="btn btn-info" style="height: 25px;border-color:info;background-color:white;color:blue;">$1</button>
	<button type="button" class="btn" style="height: 25px;border-color:blue;background-color:white;color:blue;">$2</button>
	<button type="button" class="btn" style="height: 25px;border-color:blue;background-color:white;color:blue;">$3</button>
	<button type="button" class="btn" style="height: 25px;border-color:blue;background-color:white;color:blue;">$4</button>
	<button type="button" class="btn" style="height: 25px;border-color:blue;background-color:white;color:blue;">Other</button>
	</div>-->
	...
	<span style="display:none" id="base_review_place_order_total"></span><span style="display:none" id="sales_review_place_order_total"></span></div><br />
    <br />
	   <button type="button" id="review_order_submit" style="width:410px;margin-bottom:90px;margin-left:10px;display:block" class="btn btn-lg btn-success" >Order Now</button>
